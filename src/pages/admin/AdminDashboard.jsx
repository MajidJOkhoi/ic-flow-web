      ...
      <div className="hidden border-r  md:block ">
        <div className="flex h-full max-h-screen flex-col gap-4 min-h-screen">
          <div className="flex h-14 items-center font-bold px-4 py-4 my-4 mx-4 lg:h-[80px] rounded-3xl lg:px-6  ">
            <Link
              to="/dashboard/admin"
              className="flex items-center font-bold gap-2  hover:text-white transition-colors duration-300 ease-in-out"
            >
            ...
            <form>
              <div className="relative">
                <input
                  ...
                  className="border p-2 rounded-3xl font-semibold w-full pr-10 focus:outline-none focus:ring focus:ring-green-200  md:w-2/3 lg:w-1/3"
                />
              </div>
            </form>
          </div>
